      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-gray-600">TAD에 새로운 계정을 만드세요</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-3 py-2">
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  onChange={handleChange}
                  className="w-5 h-5 rounded border-gray-300 accent-blue-600 mt-0.5 flex-shrink-0"
                />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed mt-6"
            >
              {isLoading ? '가입 중...' : '회원가입'}
            </button>
          </form>
